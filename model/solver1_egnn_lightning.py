...
from model.base import DynamicsEGNN
...
class LitModel(L.LightningModule):
    def __init__(self, config):
        ...
        self.model = DynamicsEGNN(config['node_dim'], config['edge_dim'], config['vector_dim'])
        self.dpm = DDPM()
    ...
    def transform_frame(self, batch, lmd, is_noise=False):
        ...
        with torch.no_grad():
            ...
            lmd = torch.full((1, 1), lmd, device=source_graphs.pos.device)  # or any specific lambda you want to use during testing
...
if __name__ == "__main__":
    ...
    # model = LitModel.load_from_checkpoint('/home/ziyu/PycharmProjects/pythonProject/small_sys_gnn/output/solver1_gnn_test_beta_8_1-v12.ckpt', config=config)
