...
pdb_path = '/home/ziyu/PycharmProjects/pythonProject/small_sys_gnn/output_images_debug_backward/1a10A/1a10A/final_structure_no_water.pdb'
cmd.load(pdb_path, 'final_structure_no_water')

# Load the trajectory file (XTC) into the existing topology
xtc_path = '/home/ziyu/PycharmProjects/pythonProject/small_sys_gnn/output_images_debug_backward/1a10A/backward_trajectory.xtc'
...
cmd.save('/home/ziyu/PycharmProjects/pythonProject/small_sys_gnn/output_images_debug_backward/1a10A/aligned_backward_trajectory.pse')
