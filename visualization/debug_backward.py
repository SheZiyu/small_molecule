...
from utils.auxiliary import augment_edge, extract_pdb_from_zip
...
if __name__ == "__main__":
    ...
    Model = LitModel.load_from_checkpoint(
        "/home/ziyu/PycharmProjects/pythonProject/small_sys_gnn/output/solver1_gnn_test_beta_8_1-v34.ckpt",
        config=config,
    )
            ...
            if idx == 1:
                ...
                for stop_idx in range(num_frames_to_process):
                    if stop_idx == 0:
                        ...
                        pos_list = dpm.adaptive_reverse_denoise(
                            x_T,
                            model,
                            dpm.solver1,
                            dpm.solver2,
                        ...
                        np.save(
                            os.path.join(folder, "all_positions.npy"),
                            np.array(pos_list),
                        )
