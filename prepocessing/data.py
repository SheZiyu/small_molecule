...
class DataAnalysis:
    ...
    def preprocess_coordinate_onehot(self):
        ...
        with h5py.File(self.h5_filename, "w") as hf:
            ...
            for i, (coordinates_array, one_hot_traj, atoms_num) in enumerate(
                zip(self.coordinates_arrays, self.one_hot_trajs, self.atoms_nums)
            ):
                # Create dataset
...
if __name__ == "__main__":
    ...
    loader = DataLoader(
        TrajsDataset, batch_size=2, num_workers=8, shuffle=True, pin_memory=False
    )
    for a, b in loader:
        #     print('a')
        #     # del(a)
